"""
Django settings for lms_backend_project project.
...
MIDDLEWARE = [
    ...
    "corsheaders.middleware.CorsMiddleware",  # CORS middleware for frontend
...
ROOT_URLCONF = "lms_backend_project.urls"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                "django.template.context_processors.debug",  # added on deepseek recommendation
...
WSGI_APPLICATION = "lms_backend_project.wsgi.application"
...
TIME_ZONE = "America/Halifax"  # changed timezone to Halifax
...
# Media files (uploaded by documents)
MEDIA_URL = "/media/"
